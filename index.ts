...
if (!process.env.COMPOSIO_API_KEY) {
  console.error(
    "\x1b[31m[ERROR] COMPOSIO_API_KEY is not set. This should have been set by you.\x1b[0m"
  );
}

if (!process.env.ZEP_API_KEY) {
  console.error(
    "\x1b[31m[ERROR] ZEP_API_KEY is not set. This should have been set by you.\x1b[0m"
  );
}
